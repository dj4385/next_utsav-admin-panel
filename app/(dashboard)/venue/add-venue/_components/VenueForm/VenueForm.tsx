...
const VenueForm = ({ venueData, setVenueData }: any) => {
    ...
    <div className="border-[2px] rounded-lg overflow-hidden w-full bg-white mt-4">
      ...
      <div className="grid lg:grid-cols-3 grid-cols-1 gap-4 p-2">
        ...
        <div>
          ...
          <select
            ...
            name="experience"
            onChange={handleChange}
            value={venueData?.experience?._id || ""}
          >
        ...
        <div>
          ...
          <select
            className="mt-1 block w-full p-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
            name="outdoor_catering_policy"
            onChange={handleChange}
            value={venueData?.outdoor_catering_policy || ""}
          >
        ...
        <div>
          ...
          <Input
            type="number"
            placeholder="Enter air quality index"
            onChange={handleChange}
            name="air_quality_index"
            value={venueData?.air_quality_index || 0}
          />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700">
          ...
          <Input
            ...
            onChange={handleChange}
            name="google_rating"
            value={venueData?.google_rating || 0}
          />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700">
          ...
          <Input
            type="number"
            placeholder="Enter google rating review"
            onChange={handleChange}
            name="google_rating_review"
            value={venueData?.google_rating_review || 0}
          />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700">
      ...
      <div>
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-4 p-2">
          <div>
            <label className="block text-sm font-medium text-gray-700">
              Theme Options Heading
            </label>
            <Input
              type="text"
              placeholder="Enter Theme Options Heading"
              name="theme_options_heading"
              onChange={handleChange}
              value={venueData?.theme_options_heading || ""}
              className="mt-1 w-full"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
              Theme Options Sub Heading
            </label>
            <Input
              type="text"
              placeholder="Enter Theme Options Sub Heading"
              name="theme_options_subheading"
              onChange={handleChange}
              value={venueData?.theme_options_subheading || ""}
              className="mt-1 w-full"
            />
          </div>
        </div>
